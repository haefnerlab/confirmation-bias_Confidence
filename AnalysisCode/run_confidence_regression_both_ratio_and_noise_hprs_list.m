function [conf_analysis,thresh,count] = run_confidence_regression_both_ratio_and_noise_hprs_list(subjectID,expt_type,perf_lo, perf_hi,boot_n,hpr_ridge,hpr_ar1,hpr_curvature,standardize,folds,dir,thresh_trials_only)
...
%     [best_hprs, ~] = CustomRegression.xValidatePKwithlapseSabya(signal_chosen, reg_chosen, hpr_ridge, hpr_ar1, hpr_curvature, standardize, folds);
    ...
    for j = 1:boot_n
        ...
        best_hprs = [hpr_ridge(conf_compare_cases) hpr_ar1(conf_compare_cases) hpr_curvature(conf_compare_cases)];
