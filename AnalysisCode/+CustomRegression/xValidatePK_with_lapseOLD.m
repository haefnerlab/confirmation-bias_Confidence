function [best_hprs, log_likelihoods] = xValidatePK_with_lapseOLD(data, responses, hpr_ridge, hpr_ar1, hpr_curvature, standardize, folds)
...
%         hpr_ridge(iRidge), hpr_ar1(iAR1), hpr_curvature(iCurve), 0);
    [params, ~, ~, ~, ~, ~] = ...
    CustomRegression.PsychophysicalKernelwithlapseOLD(data(dataIdx, :), responses(dataIdx), ...
        hpr_ridge(iRidge), hpr_ar1(iAR1), hpr_curvature(iCurve), 0);
