...
if params.frames==1
    centers = sign(params.category_info - rand(params.trials, 5));
    data = median((centers + randn(params.trials, 5) * sqrt(var_s)),2);
%     data = sum((centers + randn(params.trials, 5) * sqrt(var_s)),2);    
end
